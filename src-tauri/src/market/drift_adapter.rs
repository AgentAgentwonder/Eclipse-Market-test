...
pub fn generate_mock_drift_predictions() -> Vec<DriftPrediction> {
    ...
    vec![
        DriftPrediction {
            ...
            outcome_prices: vec![rng.gen_range(0.4..0.8), rng.gen_range(0.2..0.6)],
            total_volume: rng.gen_range(500000.0..5000000.0),
        ...
        DriftPrediction {
            ...
            outcomes: vec!["Yes".to_string(), "No".to_string()],
            outcome_prices: vec![rng.gen_range(0.5..0.9), rng.gen_range(0.1..0.5)],
            total_volume: rng.gen_range(250000.0..2500000.0),
        ...
        DriftPrediction {
            ...
            outcomes: vec!["Yes".to_string(), "No".to_string()],
            outcome_prices: vec![rng.gen_range(0.3..0.7), rng.gen_range(0.3..0.7)],
            total_volume: rng.gen_range(100000.0..1000000.0),
...
pub fn generate_mock_drift_markets() -> Vec<DriftMarket> {
    ...
    vec![
        DriftMarket {
            ...
            oracle_price: rng.gen_range(95.0..105.0),
            mark_price: rng.gen_range(95.0..105.0),
            funding_rate: rng.gen_range(-0.001..0.001),
            open_interest: rng.gen_range(10000000.0..50000000.0),
            volume_24h: rng.gen_range(50000000.0..500000000.0),
            number_of_users: rng.gen_range(1000..10000),
            number_of_orders: rng.gen_range(5000..50000),
        },
        DriftMarket {
            market_index: 1,
            market_type: "perp".to_string(),
            ...
            quote_asset_symbol: "USDC".to_string(),
            oracle_price: rng.gen_range(60000.0..70000.0),
            mark_price: rng.gen_range(60000.0..70000.0),
            funding_rate: rng.gen_range(-0.001..0.001),
            open_interest: rng.gen_range(50000000.0..150000000.0),
            volume_24h: rng.gen_range(200000000.0..2000000000.0),
            number_of_users: rng.gen_range(5000..50000),
            number_of_orders: rng.gen_range(10000..100000),
        },
        DriftMarket {
            market_index: 2,
            market_type: "perp".to_string(),
            ...
            quote_asset_symbol: "USDC".to_string(),
            oracle_price: rng.gen_range(3000.0..3500.0),
            mark_price: rng.gen_range(3000.0..3500.0),
            funding_rate: rng.gen_range(-0.001..0.001),
            open_interest: rng.gen_range(30000000.0..100000000.0),
            volume_24h: rng.gen_range(150000000.0..1500000000.0),
            number_of_users: rng.gen_range(3000..30000),
            number_of_orders: rng.gen_range(8000..80000),
        },
    ]
}
