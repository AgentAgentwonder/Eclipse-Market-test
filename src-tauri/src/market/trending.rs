        ...
        symbols
            ...
            .map(|(idx, (symbol, name, address))| {
                ...
                TrendingCoin {
                    ...
                    price_change_24h: rng.random_range(-15.0..25.0),
                    volume_24h: rng.random_range(500000.0..20000000.0),
                    volume_change_24h: rng.random_range(-30.0..50.0),
                    market_cap: rng.random_range(5000000.0..500000000.0),
                    social_mentions: rng.random_range(100..5000),
                    social_change_24h: rng.random_range(-20.0..80.0),
                    rank: (idx + 1) as u32,
                }
            })
            .collect()
