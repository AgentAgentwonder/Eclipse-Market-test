...
pub fn generate_mock_polymarket_markets() -> Vec<PolymarketMarket> {
    ...
    vec![
        PolymarketMarket {
            ...
            volume: rng.gen_range(100000.0..1000000.0),
            liquidity: rng.gen_range(50000.0..500000.0),
            active: true,
            closed: false,
        ...
        PolymarketMarket {
            ...
            volume: rng.gen_range(50000.0..500000.0),
            liquidity: rng.gen_range(25000.0..250000.0),
            active: true,
            closed: false,
            accepting_orders: true,
            neg_risk: false,
        ...
        PolymarketMarket {
            ...
            volume: rng.gen_range(75000.0..750000.0),
            liquidity: rng.gen_range(35000.0..350000.0),
            active: true,
            closed: false,
            accepting_orders: true,
            neg_risk: false,
