...
use defi::solend::{get_solend_reserves, get_solend_pools, get_solend_positions};
use defi::marginfi::{get_marginfi_banks, get_marginfi_positions};
use defi::kamino::{get_kamino_vaults, get_kamino_positions, get_kamino_farms};
use defi::staking::{get_staking_pools, get_staking_positions, get_staking_schedule};
use defi::yield_farming::{get_yield_farms, get_farming_opportunities, get_farming_positions};
use std::error::Error;
    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            .map_err(|e| {
                ...
                Box::new(anyhow::anyhow!(e)) as Box<dyn Error + Send + Sync>
            })?;
