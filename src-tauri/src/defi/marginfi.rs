    ...
    fn generate_mock_banks(&self) -> Vec<MarginfiBank> {
        ...
        vec![
            MarginfiBank {
                ...
                lending_apy: rng.gen_range(4.0..9.0),
                borrowing_apy: rng.gen_range(6.0..12.0),
                total_deposits: rng.gen_range(30_000_000.0..120_000_000.0),
                total_loans: rng.gen_range(10_000_000.0..80_000_000.0),
                utilization: rng.gen_range(0.4..0.75),
                risk_tier: RiskLevel::Low,
            },
            MarginfiBank {
                address: "marginfi-sol".to_string(),
                symbol: "SOL".to_string(),
                lending_apy: rng.gen_range(3.0..7.0),
                borrowing_apy: rng.gen_range(5.0..11.0),
                total_deposits: rng.gen_range(400_000.0..1_500_000.0),
                total_loans: rng.gen_range(200_000.0..900_000.0),
                utilization: rng.gen_range(0.35..0.70),
                risk_tier: RiskLevel::Medium,
            },
            MarginfiBank {
                address: "marginfi-eth".to_string(),
                symbol: "ETH".to_string(),
                lending_apy: rng.gen_range(2.5..6.5),
                borrowing_apy: rng.gen_range(4.5..9.5),
                total_deposits: rng.gen_range(10_000.0..50_000.0),
                total_loans: rng.gen_range(5_000.0..25_000.0),
                utilization: rng.gen_range(0.30..0.65),
                risk_tier: RiskLevel::Medium,
            },
        ]
    }
    ...
    fn generate_mock_account(&self, wallet: &str) -> MarginfiAccount {
        ...
        MarginfiAccount {
            ...
            assets: vec![MarginfiPosition {
                ...
                symbol: "USDC".to_string(),
                amount: rng.gen_range(5000.0..40000.0),
                value_usd: rng.gen_range(5000.0..40000.0),
                entry_price: 1.0,
            ...
            liabilities: vec![MarginfiPosition {
                ...
                value_usd: rng.gen_range(1500.0..15000.0),
                entry_price: rng.gen_range(70.0..110.0),
                liquidation_price: Some(rng.gen_range(35.0..60.0)),
            }],
            bankruptcy: false,
            health_factor: rng.gen_range(1.7..3.5),
        }
    }
}
