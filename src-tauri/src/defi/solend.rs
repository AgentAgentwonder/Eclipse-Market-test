    ...
    fn generate_mock_reserves(&self) -> Vec<SolendReserve> {
        ...
        vec![
            SolendReserve {
                ...
                supply_apy: rng.gen_range(3.5..8.5),
                borrow_apy: rng.gen_range(5.0..12.0),
                total_supply: rng.gen_range(50_000_000.0..200_000_000.0),
                total_borrow: rng.gen_range(20_000_000.0..100_000_000.0),
                available_amount: rng.gen_range(10_000_000.0..50_000_000.0),
                utilization_ratio: rng.gen_range(0.5..0.85),
                ltv: 0.80,
            ...
            SolendReserve {
                ...
                supply_apy: rng.gen_range(2.0..6.0),
                borrow_apy: rng.gen_range(4.5..10.0),
                total_supply: rng.gen_range(500_000.0..2_000_000.0),
                total_borrow: rng.gen_range(200_000.0..1_000_000.0),
                available_amount: rng.gen_range(100_000.0..500_000.0),
                utilization_ratio: rng.gen_range(0.4..0.75),
                ltv: 0.75,
            ...
            SolendReserve {
                ...
                supply_apy: rng.gen_range(3.0..7.5),
                borrow_apy: rng.gen_range(5.5..11.0),
                total_supply: rng.gen_range(40_000_000.0..150_000_000.0),
                total_borrow: rng.gen_range(15_000_000.0..80_000_000.0),
                available_amount: rng.gen_range(8_000_000.0..40_000_000.0),
                utilization_ratio: rng.gen_range(0.45..0.80),
                ltv: 0.80,
                liquidation_threshold: 0.85,
                liquidation_penalty: 0.05,
            },
    ...
    fn generate_mock_obligation(&self, _wallet: &str) -> Option<SolendObligation> {
        ...
        Some(SolendObligation {
            ...
            borrows: vec![SolendBorrow {
                ...
                value_usd: rng.gen_range(1000.0..10000.0),
            }],
            borrowed_value: rng.gen_range(1000.0..10000.0),
            deposited_value: rng.gen_range(10000.0..100000.0),
            health_factor: rng.gen_range(1.5..3.0),
            liquidation_threshold: 0.85,
        })
    }
}
