    ...
    fn generate_mock_farms(&self) -> Vec<YieldFarm> {
        ...
        vec![
            YieldFarm {
                ...
                tvl_usd: rng.gen_range(20_000_000.0..80_000_000.0),
                base_apy: rng.gen_range(8.0..12.0),
                reward_apy: rng.gen_range(4.0..13.0),
                total_apy: rng.gen_range(12.0..25.0),
                deposit_fee: 0.0,
                withdrawal_fee: 0.0,
                lock_period: None,
                risk_score: 45,
            ...
            YieldFarm {
                ...
                reward_tokens: vec!["RAY".to_string()],
                tvl_usd: rng.gen_range(8_000_000.0..30_000_000.0),
                base_apy: rng.gen_range(15.0..25.0),
                reward_apy: rng.gen_range(10.0..20.0),
                total_apy: rng.gen_range(25.0..45.0),
                deposit_fee: 0.0,
                withdrawal_fee: 0.0,
                lock_period: None,
                risk_score: 60,
            ...
            YieldFarm {
                ...
                tvl_usd: rng.gen_range(18_000_000.0..70_000_000.0),
                base_apy: rng.gen_range(10.0..15.0),
                reward_apy: rng.gen_range(5.0..13.0),
                total_apy: rng.gen_range(15.0..28.0),
                deposit_fee: 0.0,
                withdrawal_fee: 0.0,
                lock_period: None,
                risk_score: 40,
            ...
            YieldFarm {
                ...
                reward_tokens: vec!["ORCA".to_string()],
                tvl_usd: rng.gen_range(5_000_000.0..25_000_000.0),
                base_apy: rng.gen_range(20.0..30.0),
                reward_apy: rng.gen_range(10.0..25.0),
                total_apy: rng.gen_range(30.0..55.0),
                deposit_fee: 0.0,
                withdrawal_fee: 0.0,
                lock_period: None,
                risk_score: 70,
