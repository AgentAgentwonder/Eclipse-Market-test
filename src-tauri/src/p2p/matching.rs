        ...
        for offer in offers {
            ...
            matches.push(TraderMatch {
                ...
                counterparty_profile: TraderProfile {
                    ...
                    reputation_score: 60.0 + rng.gen_range(-10.0..10.0),
                    total_trades: rng.gen_range(5..200),
                    successful_trades: rng.gen_range(5..200),
                    cancelled_trades: rng.gen_range(0..20),
                    disputed_trades: rng.gen_range(0..10),
                    avg_completion_time: rng.gen_range(5..120) as i64,
                    first_trade_at: Some(DateTime::<Utc>::default()),
                    last_trade_at: Some(Utc::now()),
                    verified: rng.random_bool(0.6),
                    verification_level: rng.gen_range(0..3),
                },
            });
        }
