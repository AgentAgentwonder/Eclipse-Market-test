      ...
      <div className="flex-1 flex flex-col overflow-hidden space-y-2">
        ...
        <div className="flex items-center justify-between gap-2 mb-1">
          <div className="flex items-center gap-1 flex-1 min-w-0">
            <h2 className="text-base font-semibold text-foreground whitespace-nowrap">📈 New Coins</h2>
            <div className="flex items-center gap-1">
              <div className={`w-2 h-2 rounded-full ${isUpdating ? "bg-accent animate-pulse" : "bg-accent/50"}`} />
        ...
        <div className="flex-1 flex gap-2 overflow-hidden min-h-0">
                ...
                >
                  <div className="grid grid-cols-6 gap-1 items-center">
                    <div className="col-span-1">
                      ...
                      <div className="text-muted-foreground text-xs">Age: {getCoinAge(coin.createdAt)}</div>
                    </div>
                    <div className="bg-muted/5 p-0.5 rounded text-xs">
                      <div className="text-foreground font-medium">${(coin.marketCap / 1000000).toFixed(0)}M</div>
                    </div>
                    <div className="bg-muted/5 p-0.5 rounded text-xs">
                      <div className="text-foreground font-medium">${(coin.athMarketCap / 1000000).toFixed(0)}M</div>
                    </div>
                    <div className="bg-muted/5 p-0.5 rounded text-xs">
                  ...
                  <div className="flex items-center justify-between gap-1 mt-0.5">
                    ...
                    <div
                      className={
                        coin.change24h >= 0 ? "text-accent text-xs font-medium" : "text-red-500 text-xs font-medium"
                      }
                    >
                      {coin.change24h >= 0 ? "+" : ""}
                      {coin.change24h}%
          ...
          <div className="w-40 flex flex-col gap-1.5 overflow-y-auto">
            ...
            <div className="p-2 bg-muted/5 rounded border border-border">
              <label className="text-xs font-medium text-muted-foreground block mb-1">Min MC (M)</label>
              <input
                type="number"
            ...
            {/* Quick Buy Options */}
            <div className="p-2 bg-muted/5 rounded border border-border">
              <label className="text-xs font-medium text-muted-foreground block mb-1">Quick Buy ($)</label>
