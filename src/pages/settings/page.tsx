...
import { useSettingsStore, useShallow } from '@/store/createBoundStore';
...
export default function SettingsPage() {
  ...
  useEffect(() => {
    setPaperTradingInput(settings.paperTradingBalance.toString());
  }, [settings.paperTradingBalance]);
  ...
  const handleSavePaperTradingBalance = () => {
    ...
    settings.setPaperTradingBalance(balance);
    setSaveSuccess(true);
    setTimeout(() => setSaveSuccess(false), 3000);
  };
  ...
  const handleResetPaperTrading = () => {
    if (window.confirm('Reset paper trading balance to $10,000?')) {
      settings.resetPaperTradingBalance();
      setSaveSuccess(true);
      setTimeout(() => setSaveSuccess(false), 3000);
    }
  };
  ...
  const handleAddBuyInAmount = () => {
    ...
    const success = settings.addBuyInPreset(amount);
    if (!success) {
  ...
  const handleSetDefaultBuyIn = (amount: number) => {
    settings.setDefaultBuyIn(amount);
    setSaveSuccess(true);
    setTimeout(() => setSaveSuccess(false), 3000);
  };
  ...
  return (
    <div className="p-6 space-y-6 fade-in">
      ...
      <Card className="bg-card border-border">
        ...
        <CardContent className="space-y-4">
          {settings.phantomWallet.connected ? (
        ...
        <CardContent className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              onChange={e => settings.updateAPIKey('databaseUrl', e.target.value)}
          ...
          <div>
            ...
            <input
              ...
              onChange={e => settings.updateAPIKey('sentrySdn', e.target.value)}
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              {['claude', 'gpt4'].map(provider => (
                <button
                  key={provider}
                  onClick={() => settings.setLLMProvider(provider as 'claude' | 'gpt4')}
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={e => settings.updateAPIKey('claudeApiKey', e.target.value)}
                placeholder="sk-ant-..."
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={e => settings.updateAPIKey('openaiApiKey', e.target.value)}
                placeholder="sk-proj-..."
                className="w-full bg-input rounded px-3 py-2 pr-10 text-foreground mt-1 border border-border focus:outline-none focus:ring-2 focus:ring-primary font-mono text-xs"
              />
              <button
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={e => settings.updateAPIKey('twitterBearerToken', e.target.value)}
                placeholder="AAAA..."
                className="w-full bg-input rounded px-3 py-2 pr-10 text-foreground mt-1 border border-border focus:outline-none focus:ring-2 focus:ring-primary font-mono text-xs"
              />
              <button
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <button
                  key={themeOption.id}
                  onClick={() =>
                    settings.setTheme(themeOption.id as 'eclipse' | 'midnight' | 'cyber' | 'lunar')
                  }
