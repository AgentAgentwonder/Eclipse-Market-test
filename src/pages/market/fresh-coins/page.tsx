  ...
  return (
    <div className="p-6 space-y-6 fade-in">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Recently listed and launched tokens - updated every second</p>
      </div>

      <Card className="bg-card border-border">
        <CardHeader>
          <CardTitle>New Listings (Market Cap {(apiKeys.minMarketCap / 1000000).toFixed(0)}M+)</CardTitle>
        </CardHeader>
