      ...
      <div className={cn('space-y-2', className)}>
        {wallets.map(wallet => (
          ...
          >
            ...
            {showBalances && (
              <div className="text-sm font-bold">{formatBalance(wallet.balance)}</div>
            )}
          </button>
        ))}
      </div>
  ...
  return (
    <div className={cn('space-y-4', className)}>
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            {showBalances && (
              <button
                ...
                className={cn('p-2 rounded-lg transition-all', 'hover:bg-white/10')}
              >
      ...
      <div className="space-y-2">
        ...
        {wallets.length === 0 ? (
          <div
            className={cn('p-8 rounded-xl border text-center', 'bg-gray-500/10 border-gray-500/30')}
          >
                  ...
                  <div className="flex items-center gap-3">
                    {showBalances && (
                      <div className="text-right">
                        <div className="font-bold">{formatBalance(wallet.balance)}</div>
