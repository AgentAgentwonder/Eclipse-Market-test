...
export function APIProvider({ children }: { children: React.ReactNode }) {
  ...
  const setAPIKey = (key: keyof APIKeys, value: string | number | boolean | string[] | number[]) => {
  ...
  return <APIContext.Provider value={{ apiKeys, setAPIKey, loadAPIKeys, clearAPIKeys }}>{children}</APIContext.Provider>
}
